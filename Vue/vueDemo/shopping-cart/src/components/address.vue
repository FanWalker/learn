    ...
    <div class="address">
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="md-modal modal-msg md-modal-transition" id="showModal" v-bind:class="{'md-show':isDelete}">
...
<script>
    ...
    export default{
        ...
        mounted(){             //将编译好的html挂载到页面后执行的函数，具体参照官方文档中vue的生命周期
            this.$nextTick(()=>{
                this.getAddressList();
            });
        },
        methods: {
            ...
            deleteConfirm(address){             //是否确认删除地址
                this.isDelete = true;
